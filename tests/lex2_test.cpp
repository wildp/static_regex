// #include <srx/ast/lexv2.hpp>
// #include "tree_test.cpp" // NOLINT (bugprone-suspicious-include)
...
consteval bool parse(const CharT* str)
{
    ...
    const expr_tree<CharT> ast{ lexer::generated{ str }, tree_test_flags };
...
{
    using namespace srx::detail;
    const expr_tree<CharT> ast1{ lexer::generated{ str1 }, tree_test_flags };
    const expr_tree<CharT> ast2{ lexer::generated{ str2 }, tree_test_flags };
...
{
    using namespace srx::detail;
    const expr_tree<CharT> ast{ lexer::generated{ str } };
    return true;
}
...
/* counted reptition limit */
static_assert(parse_error("a{0,1001}"));
static_assert(parse_error("a{1001, 1001}"));

/* suspicious looking syntax */
static_assert(parse("a{-1,2}", "a\\{-1,2\\}"));
static_assert(parse("a{2,-3}", "a\\{2,-3\\}"));
static_assert(parse("a{ 2,5}", "a{2,5}"));
static_assert(parse("a{ 2  , 5 }", "a{2,5}"));
static_assert(parse("a{2 , }", "a{2,}"));
static_assert(parse("a{a,d}", "a\\{a,d\\}"));
static_assert(parse("a{", "a\\{"));
static_assert(parse("a{}", "a\\{\\}"));
static_assert(parse("a{,", "a\\{,"));
static_assert(parse("a{2", "a\\{2"));
static_assert(parse("a{2,", "a\\{2,"));
static_assert(parse("a{2,5", "a\\{2,5"));
static_assert(parse("a{1, 22, 333}", "a\\{1, 22, 333\\}"));
